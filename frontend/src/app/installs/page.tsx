  ...
  return (
    <Shell>
      <div className="space-y-6">
        <div>
          <h1 className="text-2xl font-semibold tracking-tight">Install Management</h1>
          <p className="text-sm text-muted mt-1">Install scheduling, crew coordination, and site management</p>
        </div>
        <Card>
