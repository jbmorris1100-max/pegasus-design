  ...
  return (
    <Shell>
      <div className="space-y-6">
        <div>
          <h1 className="text-2xl font-semibold tracking-tight">Job & Project Tracking</h1>
          <p className="text-sm text-muted mt-1">Full project lifecycle from lead to completion</p>
        </div>
        <Card>
