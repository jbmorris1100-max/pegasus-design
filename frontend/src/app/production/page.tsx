  ...
  return (
    <Shell>
      <div className="space-y-6">
        <div>
          <h1 className="text-2xl font-semibold tracking-tight">Production Visibility</h1>
          <p className="text-sm text-muted mt-1">Real-time shop floor data from InlineIQ</p>
        </div>
        <Card>
