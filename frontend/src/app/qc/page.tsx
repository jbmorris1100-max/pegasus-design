  ...
  return (
    <Shell>
      <div className="space-y-6">
        <div>
          <h1 className="text-2xl font-semibold tracking-tight">QC & Callbacks</h1>
          <p className="text-sm text-muted mt-1">Quality control tracking and callback/warranty management</p>
        </div>
        <Card>
